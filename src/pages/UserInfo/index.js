...
const BASE_URL = process.env.BASE_URL ? process.env.BASE_URL : 'https://bigboss.qfdk.me';
...
const UserInfo = () => {
    ...
    const importBtnHandler = () => {
        window.open(`clash://install-config?url=${BASE_URL}/api/public/sub/${params.wechatName}`);
    };
    ...
    useEffect(() => {
        if (params.wechatName) {
            httpRequest.get('/api/users/findUser', {
                params: {
                ...
                <div className="panel-body">
                    ...
                    <div className="input-group">
                        <input type="text" className="form-control"
                               ...
                               ref={clashRef}
                               readOnly={true}
                               defaultValue={`${BASE_URL}/api/public/sub/${user.wechatName}`}
                        />
